...
def register_all_pascal_voc(root):
    ...
    for name, image_dirname, sem_seg_dirname in [
        ("train", "JPEGImages", "annotations_detectron2"),
        ("train_background", "JPEGImages", "annotations_detectron2_bg"),
        ...
        if "background" in name:
            MetadataCatalog.get(name).set(image_root=image_dir, sem_seg_root=gt_dir, evaluator_type="sem_seg_background", ignore_label=255,
...
def register_all_pascal_voc_background(root):
    ...
    for name, image_dirname, sem_seg_dirname in [
        ("train_background", "image", "label_openseg_background20"),
        ...
        name = f"voc_2012_{name}_sem_seg"
        DatasetCatalog.register(name, lambda x=image_dir, y=gt_dir: load_sem_seg(y, x, gt_ext='png', image_ext='jpg'))
        MetadataCatalog.get(name).set(image_root=image_dir, sem_seg_root=gt_dir, evaluator_type="sem_seg_background", ignore_label=255, **meta,)
