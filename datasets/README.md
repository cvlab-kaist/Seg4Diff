...
$DETECTRON2_DATASETS/
  coco/                   # COCO-Stuff
  coco_subset/            # COCO subset for training
...
$SAM_DATASETS/
  ...
  annotations/
    sa_000020/
      ...
      ...
```
For training, we prepare 10k images from SA-1B dataset, which corresponds to ```sa_000020``` file from [SA-1B](https://ai.meta.com/datasets/segment-anything-downloads/). Download the tar file and extract as shown above, then run the following in `SAM_DATASETS` directory.
