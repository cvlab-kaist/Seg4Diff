...
#  --input /media/dataset1/catseg_dataset/coco/val2017/*.jpg \
#  --output $OUTPUT_DIR \
#  --opts \
...
python demo/demo.py \
 ...
 --input /home/cvlab15/project/chyun/catdog.png \
 --output $OUTPUT_DIR \
 --opts \
    MODEL.GT_ONLY_PROMPT True \
    DATASETS.TEST \(\"coco_2017_test_stuff_all_sem_seg\"\,\) \
...
# python demo/demo.py \
#  --config-file ./configs/ca_mask.yaml \
#  --input /mnt/ssd2/catseg_dataset/VOCdevkit/VOC2012/JPEGImages/*.jpg \
#  --output hist/ \
#  --opts \
#     MODEL.GT_ONLY_PROMPT True \
#     DATASETS.TEST \(\"voc_2012_test_background_sem_seg\"\,\) \
#     MODEL.SEM_SEG_HEAD.TEST_CLASS_JSON "datasets/diffsegmenter/voc20b_diffsegmenter.json" \
#     MODEL.WEIGHTS None
