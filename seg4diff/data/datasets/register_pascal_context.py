...
def register_pascal_context_59(root):
    ...
    for name, image_dirname, sem_seg_dirname in [
        ...
        ("test_background", "JPEGImages", "annotations_detectron2_bg/pc59_val"),
    ]:
        ...
        if "background" in name:
            MetadataCatalog.get(name).set(image_root=image_dir, sem_seg_root=gt_dir, evaluator_type="sem_seg", ignore_label=255, stuff_classes=["background"] + meta["stuff_classes"], stuff_colors=meta["stuff_colors"],)
        else:
...
def register_pascal_context_459(root):
    ...
    for name, image_dirname, sem_seg_dirname in [
        ...
        MetadataCatalog.get(name).set(image_root=image_dir, sem_seg_root=gt_dir, evaluator_type="sem_seg", ignore_label=459, **meta,)
